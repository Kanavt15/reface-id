...
| `anatomy-fine-v1.png` | Lip detail and the optional under-eye preset; forehead detail is masked out |
| `anatomy-age-v1.png` | Only its under-eye region is used by the live renderer |
